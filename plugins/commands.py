...
async def start_message(c,m):
    ...
    await m.reply_photo(f"https://ibb.co/dKcJ1W0",
        caption=f"<b>Hello {m.from_user.mention} 👋\n\nI Am Drax Join Request Acceptor Bot. I Can Accept All Old Pending Join Request.\n\nFor All Pending Join Request Use - /accept</b>",
        reply_markup=InlineKeyboardMarkup(
            [[
                InlineKeyboardButton('Join My Telegram Channel', url='https://t.me/+zf3n5ZOf9YkzMDRl')
            ],[
                InlineKeyboardButton("❣️ ᴅᴇᴠᴇʟᴏᴘᴇʀ", url='t.me/Rogue_DraX'),
                InlineKeyboardButton("🤖 ᴜᴘᴅᴀᴛᴇ", url='https://t.me/DraX_Society')
            ]]
        )
    )
